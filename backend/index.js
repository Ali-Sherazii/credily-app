...
// Allowed origins for CORS / Socket.IO. In production, set FRONTEND_URL to your
// deployed frontend URL(s) (comma-separated for multiple, e.g. prod + Vercel previews).
